    ...
    <div class="mx-auto p-3 bg-white shadow rounded-lg mt-6 overflow-y-auto max-h-[600px]">
        ...
        <form id="form-planeacion2" action="{{ route('planeacion.store') }}" method="POST"
            ...
            <div class="flex items-center">
                ...
                <input type="hidden" name="calc4" id="calc4" class=" border border-gray-300 rounded px-2 py-1"
                    value="{{ $datos['Calc4'] }}">
                <input type="hidden" name="calc5" id="calc5" class=" border border-gray-300 rounded px-2 py-1"
                    value="{{ $datos['Calc5'] }}">
                <input type="hidden" name="calc6" id="calc6" class=" border border-gray-300 rounded px-2 py-1"
                    value="{{ $datos['Calc6'] }}">
            </div>
            ...
            <div class="flex items-center">
                ...
                <input type="number" step="0.01" name="trama_0" id="trama_0"
                    ...
                    value="{{ isset($datos['CALIBRE_TRA']) ? number_format($datos['CALIBRE_TRA'], 2, '.', '') : '' }}">
            </div>
            ...
            <div class="flex items-center">
                ...
                <select name="hilo" id="hilo" class="w-36 border border-gray-300 rounded px-2 py-1" required>
                ...
                axios.post("{{ route('planeacion.store') }}", formData)
                    ...
                    .catch(error => {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: '¡ERROR!',
                            text: 'Ocurrió un error al intentar guardar su registro, por favor revise que los datos estén correctos.',
