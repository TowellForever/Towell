                ...
                <div class="flex ">
                    <table class="w-1/3 text-sm border-collapse border border-gray-300 mb-4">
                        ...
                        <tbody>
                            <tr>
                                <td class="border px-1 py-0.5">
                                    <input type="text" name="no_julios[]" class="form-input w-full px-1 py-1 text-xs border border-gray-300 rounded">
                                </td>
                                <td class="border px-1 py-0.5">
                                    <input type="text" name="hilos[]" class="form-input w-full px-1 py-1 text-xs border border-gray-300 rounded">
                                </td>
                            </tr>
                            <tr>
                                <td class="border px-1 py-0.5">
