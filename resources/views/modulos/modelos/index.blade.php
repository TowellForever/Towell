...
<div class="container mx-auto">
    ...
    <div class="overflow-x-auto overflow-y-auto table-container-plane table-wrapper bg-white shadow-lg rounded-lg p-1"  style="max-height: calc(100vh - 200px);">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        document.getElementById("reset-search").addEventListener("click", function () {
            window.location.href = "{{ route('modelos.index') }}"; // Redirige a la ruta planificacion.index
        });
    });
</script>
