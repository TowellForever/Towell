...
<div class="container mx-auto mt-4"> 
        ...
        <div class="bg-white shadow-md rounded-lg p-2 custom-scroll">
            ...
            <div class="overflow-y-auto max-h-60">
                ...
                <div class="flex justify-end mt-2 mb-2">
                    <button id="btnCaptura" class="px-3 w-1/6 py-1 text-xs bg-green-500 text-white rounded shadow hover:bg-green-600">CAPTURAR</button>
                </div>
            ...
            <form method="POST" action="">
                ...
                <div class="overflow-y-auto mb-4  md:h-60 h-100">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center">
                            <label for="inputAtadoraStaubli" class="w-40 text-xs text-gray-600 font-medium">ATADORA STAUBLI:</label>
                            <input type="radio" name="atadora" id="inputAtadoraStaubli" value="ATADORA STAUBLI" class="w-10 h-10 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500">
                        </div>
                        
                        <div class="flex items-center">
                            <label for="inputAtadoraUster" class="w-40 text-xs text-gray-600 font-medium">ATADORA USTER:</label>
                            <input type="radio" name="atadora" id="inputAtadoraUster" value="ATADORA USTER" class="w-10 h-10 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="flex flex-col">
                            <label for="inputObservaciones" class="text-xs text-gray-600 font-medium mb-1">OBSERVACIONES:</label>
                        ...
                        <p class="text-xs font-semibold text-red-700 bg-red-100 border-l-4 border-red-500 p-3 rounded-md shadow-sm">
                            NOTA: EN ATADOS DE RIZO DE SALÓN LISOS SE DEBE MONTAR CON GRÚA HUBTEX (REUMA) LAS CUENTAS 2524 Y 2766 PARA CUIDAR EL RENDIMIENTO DE GRÚA GENKINGER, SE CONSIDERA EN INDIADOR.
                        </p>
                ...
                <div class="mt-5 flex justify-end space-x-2 border-t pt-3">
                    <button type="button" id="cerrarModal" class="w-1/4 px-3 py-1 text-sm bg-gray-400 text-white rounded hover:bg-gray-500">Cancelar</button>
                    <button type="submit" class="w-1/4 px-3 py-1 text-sm bg-green-600 text-white rounded hover:bg-green-700">Guardar</button>
                </div>
            </form>
        </div>
    </div>
    ...
    @push('styles')
        <style>
            ...
            .fila-seleccionada {
                background-color: #faf089 !important; /* Más fuerte al seleccionar */
            }
        </style>
