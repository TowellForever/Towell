    ...
    <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-2xl p-6">
        <form action="{{ route('usuarios.store') }}" method="POST" enctype="multipart/form-data"> 
            ...
            <div class="mb-4">
                ...
                <input type="text" name="numero_empleado" id="numero_empleado" class="w-full p-2 border rounded-lg" required>
            </div>
            ...
            <div class="input-group">
                ...
                <div class="password-container">
                    ...
                    <button type="button" id="togglePassword" class="eye-icon">Mostrar Contraseña</button>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="foto" id="foto" class="w-full p-2 border rounded-lg" accept="image/*" onchange="previewImage(event)">
