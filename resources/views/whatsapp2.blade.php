    ...
    <div class="container mx-auto mt-10 max-w-2xl">
        ...
        <form action="/send-whatsapp2" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="flex items-center gap-2">
                ...
                <select name="clave_falla" id="clave_falla" class="flex-1 p-1 border border-gray-300 rounded text-sm"
                    required>
            ...
            <div class="flex items-center gap-2">
                ...
                <input type="date" id="fecha_reporte" name="fecha_reporte"
                    class="flex-1 p-1 border border-gray-300 rounded text-sm" required>
            </div>

            <!-- Hora -->
            <div class="flex items-center gap-2">
                <label class="w-28 text-base font-semibold text-gray-800">Hora:</label>
                <input type="time" id="hora_reporte" name="hora_reporte"
                    class="flex-1 p-1 border border-gray-300 rounded text-sm" required>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <input type="text" name="operador" class="flex-1 p-1 border border-gray-300 rounded text-sm"
