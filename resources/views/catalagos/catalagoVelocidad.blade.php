    ...
    <div class="container">
        ...
        <form method="GET" action="{{ route('velocidad.index') }}" class="mb-4">
            <div class="row p-3 rounded" style="background-color: #003366;">
                ...
                <div class="col-md-2">
                    <input type="text" name="velocidad" class="form-control" placeholder="Buscar por velocidad"
                        value="{{ request('velocidad') }}">
                </div>
                <div class="col-md-2">
        ...
        <table class="table table-bordered table-sm">
            <thead class="text-center bg-light">
                <tr>
                    ...
                    <th onclick="sortTable(2, this)" style="width: 15%;">Velocidad</th>
        ...
        <div class="d-flex justify-content-center mt-4">
            <!--Nuevo código para evitar explosion en la paginación o desbordmiento de numeros-->
            @php
