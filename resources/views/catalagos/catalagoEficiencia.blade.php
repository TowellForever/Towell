...
<div class="container">
    ...
    <form method="GET" action="{{ route('eficiencia.index') }}" class="mb-4">
        <div class="row p-3 rounded" style="background-color: #003366;">
            ...
            <div class="col-md-2">
                <input type="text" name="eficiencia" class="form-control" placeholder="Buscar por eficiencia" value="{{ request('eficiencia') }}">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-12 mt-2 d-flex flex-wrap justify-content-between">
                ...
                <div class="d-flex flex-wrap justify-content-md-end justify-content-center col-12 col-md-auto">
                    ...
                    <a href="{{ route('eficiencia.index') }}" class="btn btn-secondary px-4 py-2 mx-1 col-12 col-md-auto">
                        Restablecer
                    </a>
                </div>
            </div>
